...
function processOrderConfirmation() {
    ...
    // Generate Sequential Order Reference Code
    let currentSeq = parseInt(localStorage.getItem("nafc_order_seq") || "1", 10);
    const orderRef = `NAFC-${String(currentSeq).padStart(4, '0')}`;
    localStorage.setItem("nafc_order_seq", currentSeq + 1);
